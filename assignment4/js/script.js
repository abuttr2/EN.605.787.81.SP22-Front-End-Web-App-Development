...
var aboutTitleHtml = "snippets/about-snippet-title.html";
var aboutHtml = "snippets/about-snippet.html";
var aboutHtmlURL = "https://davids-restaurant.herokuapp.com/categories.json";
...
function buildStarsHtml(stars, aboutHtml) {
  ...
  //empty star
  for (let i = stars; i <= 5 && stars != 5; i++) {
    html = insertProperty(html, "star" + i, "fa fa-star-o")
  }
